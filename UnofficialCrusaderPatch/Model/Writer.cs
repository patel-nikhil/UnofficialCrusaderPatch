...
namespace UCP
{
    internal class Writer
    {
        ...
        {
            if (installData.CodeAllocationCounter > 0)
            {
            ...
            {
                codeSectionStart = -1;
                codeSectionVirtualStart = -1;
            }
            
            if (installData.MemoryAllocationCounter > 0)
            {
        ...
        internal static int WriteCode(AssemblyElement element, Dictionary<string, Label> labelDictionary, byte[] data, int currentPosition, int allocatedCodeSectionStart, int allocatedCodeSectionVirtualStart, int allocatedMemorySectionStart, int allocatedMemorySectionVirtualStart, int section)
        {
